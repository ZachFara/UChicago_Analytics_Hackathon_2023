...
csvfile = open('data/steam_review_data_with_time.csv', 'a', newline='')
...
class SteamSubscriber:
    ...
    def __init__(self, topic="steam-reviews-json", ensign_creds=""):
        """
        Parameters
        ----------
    ...
    async def handle_event(self, event):
        ...
        csv_line = f"{data['game']},{data['id']},{data['num_reviews']},{data['review']},{data['timestamp_created']},{data['time_retrieved']},{data['author_playtime']},{data['author_games_owned']},{data['author_reviews']},{current_time}\n"
